...
Emu_imp_init()
{
  ...
  rx.imp.sha_vtx = Emu_shader_create_bytecode(EMU_kVERTEX_SHADER_BIT, "default_vs",sizeof(rx_vs_shader_bytecode),(void*)rx_vs_shader_bytecode);
  rx.imp.sha_pxl = Emu_shader_create_bytecode(EMU_kPIXEL_SHADER_BIT, "default_ps",sizeof(rx_ps_shader_bytecode),(void*)rx_ps_shader_bytecode);
  rx.imp.sha_pxl_txt = Emu_shader_create_bytecode(EMU_kPIXEL_SHADER_BIT|EMU_kSOURCE_BLENDING_BIT, "ps_txt",sizeof(rx_ps_txt_sb),(void*)rx_ps_txt_sb);
  rx.imp.sha_pxl_txt_sdf = Emu_shader_create_bytecode(EMU_kPIXEL_SHADER_BIT, "ps_txt_sdf",sizeof(rx_ps_txt_sdf_sb),(void*)rx_ps_txt_sdf_sb);
  rx.imp.sha_vtx_sdf = Emu_shader_create_bytecode(EMU_kVERTEX_SHADER_BIT, "vs_sdf",sizeof(rx_vs_sdf_sb),(void*)rx_vs_sdf_sb);
  rx.imp.sha_pxl_sdf_cir = Emu_shader_create_bytecode(EMU_kPIXEL_SHADER_BIT, "ps_sdf_cir",sizeof(rx_ps_sdf_cir_sb),(void*)rx_ps_sdf_cir_sb);
  rx.imp.sha_pxl_sdf_box = Emu_shader_create_bytecode(EMU_kPIXEL_SHADER_BIT, "ps_sdf_box",sizeof(rx_ps_sdf_box_sb),(void*)rx_ps_sdf_box_sb);
